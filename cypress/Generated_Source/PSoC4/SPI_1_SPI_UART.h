...
#define SPI_1_SPI_NUMBER_OF_SS_LINES     (4u)
#define SPI_1_SPI_RX_BUFFER_SIZE         (16u)
#define SPI_1_SPI_TX_BUFFER_SIZE         (16u)

#define SPI_1_SPI_INTERRUPT_MODE         (2u)

#define SPI_1_SPI_INTR_RX_MASK           (0x1u)
#define SPI_1_SPI_INTR_TX_MASK           (0x1u)

#define SPI_1_SPI_RX_TRIGGER_LEVEL       (5u)
#define SPI_1_SPI_TX_TRIGGER_LEVEL       (5u)

#define SPI_1_SPI_BYTE_MODE_ENABLE       (1u)
