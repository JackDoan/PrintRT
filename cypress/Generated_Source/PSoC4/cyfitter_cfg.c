...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x00003FFFu);
		...
		CY_SET_REG32((void *)(CYDEV_UDB_PA0_BASE), 0x00990400u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x00400080u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC2), 0x00000007u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x0000000Du);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00000D8Eu);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_INTR_CFG), 0x00003FFCu);
